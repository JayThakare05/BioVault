...
export default function FaceScanner({ onScanComplete, onCancel }) {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (videoRef.current) {
          ...
          videoRef.current.onloadedmetadata = () => {
            console.log("Face Scanner: Video metadata loaded.");
    ...
    async function detectFace() {
        ...
        try {
            // Use specific options with lower minConfidence for better detection
            ...
            if (result) {
                console.log("Face Scanner: Face detected!", result.detection.score);
                setPhase('success');
